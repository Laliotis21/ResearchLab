...
namespace ResearchLab_Library.Migrations
{
    ...
    [Migration("20220128201703_Remove Category from Publication Class")]
    partial class RemoveCategoryfromPublicationClass
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResearchLab_Library.Model.LabLessons", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("LabsLessons");
                });

            modelBuilder.Entity("ResearchLab_Library.Model.LessonType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ResearchLab_Library.Model.LabLessons", b =>
                {
                    b.HasOne("ResearchLab_Library.Model.LessonType", "LessonType")
                        .WithMany()
